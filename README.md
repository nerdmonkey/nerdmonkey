...
- Cloud-savvy across AWS, Azure, and GCP
- Full-stack skills: Python (FastAPI), PHP (Laravel), NodeJS, ReactJS, React Native
...
| Other Tools      | Jira, Confluence, Linux, IoT, Drone Tech |
